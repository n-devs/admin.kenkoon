...
function useKenkoonHQManager(url) {
    ...
    const [columns] = useState([
        ...
        {
            title: 'img0', field: 'img0', render: rowData => (rowData.img0 !== undefined ? (<img src={(rowData.img0.base64)} style={{ width: 40, borderRadius: '5%' }} />) : ""), editComponent: props => {
        ...
        {
            title: 'img1', field: 'img1', render: rowData => (rowData.img1 !== undefined ? (<img src={(rowData.img1.base64)} style={{ width: 40, borderRadius: '5%' }} />) : ""), editComponent: props => {
        ...
        {
            title: 'img2', field: 'img2', render: rowData => (rowData.img2 !== undefined ? (<img src={(rowData.img2.base64)} style={{ width: 40, borderRadius: '5%' }} />) : ""), editComponent: props => {
        ...
        {
            title: 'img3', field: 'img3', render: rowData => (rowData.img3 !== undefined ? (<img src={(rowData.img3.base64)} style={{ width: 40, borderRadius: '5%' }} />) : ""), editComponent: props => {
...
export default useKenkoonHQManager;